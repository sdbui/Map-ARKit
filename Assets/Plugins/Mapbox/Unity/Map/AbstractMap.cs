namespace Mapbox.Unity.Map
{
	...
	public class AbstractMap : MonoBehaviour, IMap
	{
		...
		public event Action OnTileLoaded = delegate { };
		...
		protected virtual void Awake()
		{
			...
			_mapVisualizer.OnMapVisualizerStateChanged += MapVisualizer_OnStateChanged;
		...
		protected virtual void Start()
		{
			...
			_mapCenterMercator = Conversions.LatLonToMeters(_mapCenterLatitudeLongitude);
