    ...
    public class HeightModifier : MeshModifier
    {
        ...
        public override void Run(VectorFeatureUnity feature, MeshData md, UnityTile tile = null)
        {
            ...
            if (!_forceHeight)
            {
				...
				if (feature.Properties.ContainsKey("crimeIndex"))
				{
					int crimeIndex;
					if (int.TryParse(feature.Properties["crimeIndex"].ToString(), out crimeIndex))
					{
						hf = crimeIndex * crimeIndex * 20;
					}
				}
            }
            ...
            for (int i = 0; i < md.Edges.Count; i+=2)
            {
                ...
                // map each wall face to [0,1] in UV space
                wallUv.Add(new Vector2(0, 0));
                wallUv.Add(new Vector2(1, 0));
                wallUv.Add(new Vector2(0, 1));
                wallUv.Add(new Vector2(1, 1));
