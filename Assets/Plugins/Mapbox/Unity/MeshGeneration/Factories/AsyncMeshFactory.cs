namespace Mapbox.Unity.MeshGeneration.Factories
{
	...
	/// </summary>
	[CreateAssetMenu(menuName = "Mapbox/Factories/Async Mesh Factory")]
	public class AsyncMeshFactory : AbstractTileFactory
	{
		[SerializeField]
		private string _mapId = "";
		public List<AsyncLayerVisualizerBase> Visualizers;

		private Dictionary<string, List<AsyncLayerVisualizerBase>> _layerBuilder;

		public void OnEnable()
		{
			if (Visualizers == null)
			{
				Visualizers = new List<AsyncLayerVisualizerBase>();
			}
		}
		...
		{
			_layerBuilder = new Dictionary<string, List<AsyncLayerVisualizerBase>>();
			foreach (AsyncLayerVisualizerBase factory in Visualizers)
			{
				...
				{
					_layerBuilder.Add(factory.Key, new List<AsyncLayerVisualizerBase>() { factory });
				}
			}
		}
